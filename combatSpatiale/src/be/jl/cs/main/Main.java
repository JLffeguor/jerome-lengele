...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * J'utilise ici le pattern strategy
		 * Je vais utiliser le fait d'avoir isoler ce qui peut varier dans le vaisseau ( le mode de déplacement)
		 * et je vais pouvoir modifer le type de déplacement du petit transporteur sans devoir intervenir dans le code ^^
		 * 
		 * ceci permetra plus tard de pouvoir changer le mode de propulsion au fur et a mesure que des technologie seront développée.
		 */
	...
	System.out.println("le vaisseau a " + pt1.getFret() + " de taille de soute" );
